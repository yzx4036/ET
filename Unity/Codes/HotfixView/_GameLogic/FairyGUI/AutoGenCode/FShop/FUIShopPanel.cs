...
{
    [ObjectSystem]
    public class FUIShopPanelAwakeSystem : AwakeSystem<FUIShopPanel, FUI>
    {
        public override void Awake(FUIShopPanel self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FUIShopPanel : Entity, IAwake<FUI>
    {	
