...
{
    [ObjectSystem]
    public class FAttrPanelAwakeSystem : AwakeSystem<FAttrPanel, GObject>
    {
        public override void Awake(FAttrPanel self, GObject go)
        {
            self.Awake(go);
        }
    }
        
    public sealed class FAttrPanel : FUI
    {	
        ...
        public void Awake(GObject go)
        {
			...
			if(com != null)
			{
    			...
    			CloseBtn = AddChild<FButton_Close, GObject>(com.GetChildAt(1));
    			...
    			CloseBtnD = AddChild<FButton4_Normal, GObject>(com.GetChildAt(48));
