...
{
    [ObjectSystem]
    public class FButton_GrilAwakeSystem : AwakeSystem<FButton_Gril, GObject>
    {
        public override void Awake(FButton_Gril self, GObject go)
        {
            self.Awake(go);
        }
    }
        
    public sealed class FButton_Gril : FUI
    {	
