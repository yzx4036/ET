...
{
    unsafe class BundleSystem_BundleManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(BundleSystem.BundleManager);
            args = new Type[]{};
            method = type.GetMethod("get_Initialized", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Initialized_0);
            ...
            app.RegisterCLRMethodRedirection(method, ReleaseObject_5);


        }


        static StackObject* get_Initialized_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);


            var result_of_this_method = BundleSystem.BundleManager.Initialized;
        ...
        static StackObject* Initialize_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Boolean @autoReloadBundle = ptr_of_this_method->Value == 1;


            var result_of_this_method = BundleSystem.BundleManager.Initialize(@autoReloadBundle);
        ...
        static StackObject* Clear_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            BundleSystem.BundleManager.Clear();
        ...
        static StackObject* Load_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = BundleSystem.BundleManager.Load<UnityEngine.GameObject>(@bundleName, @assetName);
        ...
        static StackObject* Instantiate_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = BundleSystem.BundleManager.Instantiate(@original);

            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static StackObject* ReleaseObject_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            BundleSystem.BundleManager.ReleaseObject(@obj);
