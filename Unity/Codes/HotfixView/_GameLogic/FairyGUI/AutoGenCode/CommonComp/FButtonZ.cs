...
{
    [ObjectSystem]
    public class FButtonZAwakeSystem : AwakeSystem<FButtonZ, FUI>
    {
        public override void Awake(FButtonZ self, FUI fui)
        {
            self.Awake(fui);
        }
    }
        
    public sealed class FButtonZ : Entity, IAwake<FUI>
    {	
