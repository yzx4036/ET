...
namespace SEyesETEditor
{
    ...
    {
    	private const string CodeResPath = "Assets/Res/Code/";
    	private static List<string> HotfixDllList = new List<string>(){"Hotfix.dll", "HotfixView.dll"};
        ...
        static void GenerateCLRBindingByAnalysis()
        {
            ...
            foreach (string dll in HotfixDllList)
            {
    	        using (FileStream fs = new FileStream($"{CodeResPath}{dll}.bytes", FileMode.Open, FileAccess.Read))
    	        {
