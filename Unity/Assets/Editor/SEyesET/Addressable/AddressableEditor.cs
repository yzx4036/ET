/** 
* @Author PC-E_Ye 
* @Mail E_Ye@outlook.com
* @Date 2021年3月2日 14:13:52
*/
...
namespace ETEditor
{
    public class AddressableEditor
    {
        ...
        /// 对bundle文件夹资源自动分组
        /// </summary>
        [MenuItem("Create/SetGroup => Auto Group")]
        public static void AutoGroupByFolder()
        {
            var _dir = Directory.GetDirectories(RootPath);
            Debug.Log($">{_dir.Length}");
        }

        // private static void CheckPackByLevel(BundlesResType)
        // {
        //     
        // }
