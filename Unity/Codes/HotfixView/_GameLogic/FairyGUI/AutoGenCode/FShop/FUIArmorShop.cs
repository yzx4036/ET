...
{
    [ObjectSystem]
    public class FUIArmorShopAwakeSystem : AwakeSystem<FUIArmorShop, FUI>
    {
        public override void Awake(FUIArmorShop self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FUIArmorShop : Entity, IAwake<FUI>
    {	
