    ...
    unsafe class SEyesSoft_AddressableMgr_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("LoadAssetsAsync", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(System.Threading.Tasks.Task<System.Collections.Generic.IList<System.Object>>), typeof(System.Collections.IEnumerable), typeof(UnityEngine.AddressableAssets.Addressables.MergeMode)))
                    {
        ...
        static StackObject* LoadAssetsAsync_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.LoadAssetsAsync<System.Object>(@keys, @mode);
