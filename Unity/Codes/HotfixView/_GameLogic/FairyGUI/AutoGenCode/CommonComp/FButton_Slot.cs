...
{
    [ObjectSystem]
    public class FButton_SlotAwakeSystem : AwakeSystem<FButton_Slot, FUI>
    {
        public override void Awake(FButton_Slot self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FButton_Slot : Entity, IAwake<FUI>
    {	
