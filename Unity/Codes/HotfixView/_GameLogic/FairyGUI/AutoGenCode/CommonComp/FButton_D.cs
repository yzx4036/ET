...
{
    [ObjectSystem]
    public class FButton_DAwakeSystem : AwakeSystem<FButton_D, FUI>
    {
        public override void Awake(FButton_D self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FButton_D : Entity, IAwake<FUI>
    {	
