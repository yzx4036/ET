...
{
    [ObjectSystem]
    public class FButton_CreateAwakeSystem : AwakeSystem<FButton_Create, FUI>
    {
        public override void Awake(FButton_Create self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FButton_Create : Entity, IAwake<FUI>
    {	
