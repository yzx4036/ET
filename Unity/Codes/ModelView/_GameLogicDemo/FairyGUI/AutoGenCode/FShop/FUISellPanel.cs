...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FUISellPanel self, GObject gObject) where T : Entity, IAwake, new()
        {
        ...
        [ObjectSystem]
        public class FUISellPanelAwakeSystem: AwakeSystem<FUISellPanel>
        {
            public override void Awake(FUISellPanel self)
            {
    ...
    public sealed class FUISellPanel: Entity, IAwake, IDestroy
    {
