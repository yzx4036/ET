...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FUICharacterSelect self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
    ...
    public sealed class FUICharacterSelect: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
