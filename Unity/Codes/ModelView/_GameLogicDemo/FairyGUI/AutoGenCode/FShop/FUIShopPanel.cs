...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FUIShopPanel self, GObject gObject) where T : Entity, IAwake, new()
        {
        ...
        [ObjectSystem]
        public class FUIShopPanelAwakeSystem: AwakeSystem<FUIShopPanel>
        {
            public override void Awake(FUIShopPanel self)
            {
    ...
    public sealed class FUIShopPanel: Entity, IAwake, IDestroy
    {
