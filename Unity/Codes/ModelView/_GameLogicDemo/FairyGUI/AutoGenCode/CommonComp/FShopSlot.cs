...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FShopSlot self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
    ...
    public sealed class FShopSlot: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
