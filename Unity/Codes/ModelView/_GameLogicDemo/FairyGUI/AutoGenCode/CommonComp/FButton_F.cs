...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FButton_F self, GObject gObject) where T : Entity, IAwake, new()
        {
        ...
        [ObjectSystem]
        public class FButton_FAwakeSystem: AwakeSystem<FButton_F>
        {
            public override void Awake(FButton_F self)
            {
    ...
    public sealed class FButton_F: Entity, IAwake, IDestroy
    {
