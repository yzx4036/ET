...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_GComponent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_numChildren_2);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("GetChildAt", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetChildAt_3);
            args = new Type[]{typeof(System.Int32)};
        ...
        static StackObject* get_numChildren_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetChildAt_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
