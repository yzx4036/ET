...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FUIWeaponShop self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
    ...
    public sealed class FUIWeaponShop: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
