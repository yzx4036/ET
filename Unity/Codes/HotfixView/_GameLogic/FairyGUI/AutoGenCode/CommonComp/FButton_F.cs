...
{
    [ObjectSystem]
    public class FButton_FAwakeSystem : AwakeSystem<FButton_F, FUI>
    {
        public override void Awake(FButton_F self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FButton_F : Entity, IAwake<FUI>
    {	
