...
{
    [ObjectSystem]
    public class FButton_CreateAwakeSystem : AwakeSystem<FButton_Create, GObject>
    {
        public override void Awake(FButton_Create self, GObject go)
        {
            self.Awake(go);
        }
    }
        
    public sealed class FButton_Create : FUI
    {	
