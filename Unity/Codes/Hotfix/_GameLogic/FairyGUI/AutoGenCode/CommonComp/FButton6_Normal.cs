...
{
    [ObjectSystem]
    public class FButton6_NormalAwakeSystem : AwakeSystem<FButton6_Normal, GObject>
    {
        public override void Awake(FButton6_Normal self, GObject go)
        {
            self.Awake(go);
        }
    }
        
    public sealed class FButton6_Normal : FUI
    {	
