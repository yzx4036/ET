...
{
    [ObjectSystem]
    public class FButton_NormalAwakeSystem : AwakeSystem<FButton_Normal, FUI>
    {
        public override void Awake(FButton_Normal self, FUI fui)
        {
            self.Awake(fui);
        }
    }
    ...
    public sealed class FButton_Normal : Entity, IAwake<FUI>
    {	
