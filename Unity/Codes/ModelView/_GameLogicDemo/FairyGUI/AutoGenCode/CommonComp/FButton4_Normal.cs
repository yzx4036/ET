...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FButton4_Normal self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
    ...
    public sealed class FButton4_Normal: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
