...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FButton_Boy self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
        ...
        [ObjectSystem]
        public class FButton_BoyAwakeSystem: AwakeSystem<FButton_Boy, FUIGObjectComponent>
        {
            public override void Awake(FButton_Boy self, FUIGObjectComponent fui)
            {
    ...
    public sealed class FButton_Boy: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
