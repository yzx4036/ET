...
{
    [ObjectSystem]
    public class FButton_NormalAwakeSystem : AwakeSystem<FButton_Normal, GObject>
    {
        public override void Awake(FButton_Normal self, GObject go)
        {
            self.Awake(go);
        }
    }
        
    public sealed class FButton_Normal : FUI
    {	
