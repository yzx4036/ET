...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FUITips self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
        ...
        [ObjectSystem]
        public class FUITipsAwakeSystem: AwakeSystem<FUITips, FUIGObjectComponent>
        {
            public override void Awake(FUITips self, FUIGObjectComponent fui)
            {
    ...
    public sealed class FUITips: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
