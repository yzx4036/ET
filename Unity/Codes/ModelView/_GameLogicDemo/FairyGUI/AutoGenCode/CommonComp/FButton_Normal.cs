...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FButton_Normal self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
        ...
        [ObjectSystem]
        public class FButton_NormalAwakeSystem: AwakeSystem<FButton_Normal, FUIGObjectComponent>
        {
            public override void Awake(FButton_Normal self, FUIGObjectComponent fui)
            {
    ...
    public sealed class FButton_Normal: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
