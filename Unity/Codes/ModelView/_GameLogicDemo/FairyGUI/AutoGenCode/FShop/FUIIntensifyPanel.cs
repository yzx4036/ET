...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FUIIntensifyPanel self, GObject gObject) where T : Entity, IAwake<FUIGObjectComponent>, new()
        {
        ...
        [ObjectSystem]
        public class FUIIntensifyPanelAwakeSystem: AwakeSystem<FUIIntensifyPanel, FUIGObjectComponent>
        {
            public override void Awake(FUIIntensifyPanel self, FUIGObjectComponent fui)
            {
    ...
    public sealed class FUIIntensifyPanel: Entity, IAwake<FUIGObjectComponent>, IDestroy
    {
