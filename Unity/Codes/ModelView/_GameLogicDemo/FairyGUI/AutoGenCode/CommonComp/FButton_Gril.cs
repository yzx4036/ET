...
namespace ET
{
    ...
    {
        private static T CreateFUICompInst<T>(FButton_Gril self, GObject gObject) where T : Entity, IAwake, new()
        {
        ...
        [ObjectSystem]
        public class FButton_GrilAwakeSystem: AwakeSystem<FButton_Gril>
        {
            public override void Awake(FButton_Gril self)
            {
    ...
    public sealed class FButton_Gril: Entity, IAwake, IDestroy
    {
