...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Y0StudioSoft_GameObjectMgr_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.String), typeof(UnityEngine.Transform), typeof(System.Boolean)};
            method = type.GetMethod("GetGameObjectAsync", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetGameObjectAsync_1);


        }


        static StackObject* RecycleGameObject_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.GameObject @ins = (UnityEngine.GameObject)typeof(UnityEngine.GameObject).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* GetGameObjectAsync_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
